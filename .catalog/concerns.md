...
| Entry point mobile do Tauri não se aplica ao shell desktop | Runtime | Baixa | PR #55 / thread PRRT_kwDOSZGoZs6CnVBk / reviewer copilot-pull-request-reviewer | A aplicação é desktop-only na PRD e na arquitetura; ajustar `mobile_entry_point` não agrega valor nesta entrega. | Reavaliar apenas se houver decisão explícita de suportar mobile. | 2026-05-17 |
| Entry point mobile do Tauri não se aplica ao shell desktop | Runtime | Baixa | PR #55 / thread PRRT_kwDOSZGoZs6CpHUs / reviewer copilot-pull-request-reviewer | A aplicação é desktop-only na PRD e na arquitetura; ajustar `mobile_entry_point` não agrega valor nesta entrega. | Reavaliar apenas se houver decisão explícita de suportar mobile. | 2026-05-17 |
| Entry point mobile do Tauri não se aplica ao shell desktop | Runtime | Baixa | PR #55 / thread PRRT_kwDOSZGoZs6CpKwl / reviewer copilot-pull-request-reviewer | A aplicação é desktop-only na PRD e na arquitetura; ajustar `mobile_entry_point` não agrega valor nesta entrega. | Reavaliar apenas se houver decisão explícita de suportar mobile. | 2026-05-17 |
